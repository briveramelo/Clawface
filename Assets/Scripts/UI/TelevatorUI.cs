...
public class TelevatorUI : MonoBehaviour {
    ...
    [SerializeField]
    private Image arena, armory, trials;

    //// Constants
    private static Color SELECTED = new Color(0x32 / 255.0F, 0xD2 / 255.0F, 0xBE / 255.0F);
    private static Color UNSELECTED = new Color(0x32 / 255.0F, 0x83 / 255.0F, 0xD2 / 255.0F);
