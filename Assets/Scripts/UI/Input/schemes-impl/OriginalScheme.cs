...
public class OriginalScheme : IControlScheme {
    ...
    #region Public Interface
        ...
        public Vector2 GetAxes(List<IController> controllers, string axes)
        {
            bool left;
            switch(axes)
            {
        ...
        public ButtonMode[] GetAction(List<IController> controllers, string action)
        {
        ...
        public bool GetAction(List<IController> controllers, string action, ButtonMode mode)
        {
            foreach (IController controller in controllers)
            {
                switch (action)
