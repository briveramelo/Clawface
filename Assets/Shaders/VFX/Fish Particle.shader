...
Shader "Fish Particle"
{
	...
	SubShader
	{
		...
		uniform float _FloppingSpeed;
		uniform float _FloppingRate;
		uniform float _FloppingDistance;

		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			UNITY_INITIALIZE_OUTPUT( Input, o );
			float3 ase_vertex3Pos = v.vertex.xyz;
			float4 appendResult20 = (float4(0.0 , 0.0 , sin( ( ( _Time.y * _FloppingSpeed ) + ( ase_vertex3Pos.x * _FloppingRate ) ) ) , 0.0));
			float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
			v.vertex.xyz += ( appendResult20 * _FloppingDistance * float4( ase_objectScale , 0.0 ) ).xyz;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Smoothness = ( tex2D( _Fish_Smoothness, uv_Fish_Smoothness ) * 1.2 ).r;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=13903
2065;96;1768;977;1572.77;40.28009;1;True;True
Node;AmplifyShaderEditor.PosVertexDataNode;24;-1242.645,452.8527;Float;False;0;0;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;29;-1227.616,597.4086;Float;False;Property;_FloppingRate;Flopping Rate;19;0;1.68;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;25;-1128.047,368.3139;Float;False;Property;_FloppingSpeed;Flopping Speed;19;0;16.03;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;3;-635,-63.5;Float;True;Property;_Fish_Smoothness;Fish_Smoothness;2;0;Assets/Textures/VFX/Fish_Smoothness.png;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;22;-413.8867,529.3311;Float;False;Property;_FloppingDistance;Flopping Distance;19;0;0.76;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;2;-385.985,133.2001;Float;False;Constant;_Smoothness;Smoothness;1;0;1.2;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;1;-329.4001,-261.4;Float;True;Property;_Fish_Albedo;Fish_Albedo;0;0;Assets/Textures/VFX/Fish_Albedo.png;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
ASEEND*/
//CHKSM=055FD8B49A4CB253069E43CC0BC588B2EAB1D091