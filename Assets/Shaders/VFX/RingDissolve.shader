Shader "Unlit/RingDissolve"
{
	Properties
	{
		...
		_DissolveSpeed("Dissolve Speed", Range(0.0, 100.0)) = 1.0
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				c.a = c.a * tex2D(_DissolveTex, i.uv * _DissolveTex_ST.xy + _DissolveTex_ST.zw + (float2(1.0, 1.0) * _Time.y * _DissolveSpeed)).r;
				return c;
			}
			ENDCG
		}
