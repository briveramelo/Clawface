...
Shader "PBR Glow Outline"
{
	Properties
	{
		_ASEOutlineColor( "Outline Color", Color ) = (1,0,0,0)
		_ASEOutlineGlowStrength ("Outline Glow Strength", Float) = 1
	...
	SubShader
	{
		...
		uniform fixed _ASEOutlineGlowStrength;
		...
		void outlineSurf( Input i, inout SurfaceOutput o ) { o.Emission = _ASEOutlineColor.rgb * _ASEOutlineGlowStrength; o.Alpha = 1; }
		ENDCG
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_cast_0 = (float4(1,0,0,0)).xxxx;
...
/*ASEBEGIN
Version=13401
1998;29;1767;1004;1660.484;1614.183;2.060849;True;True
...
Node;AmplifyShaderEditor.SamplerNode;1;-436.6,-720.5001;Float;True;Property;_Albedo;Albedo;0;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
ASEEND*/
//CHKSM=93DDC3E3301F566D4ABE659D0D13832B66656ABB