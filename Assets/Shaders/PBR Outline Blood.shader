...
Shader "PBR Outline Blood"
{
	Properties
	{
		...
		_BloodMaskScale("Blood Mask Scale", Range( 0 , 10)) = 1
		_BloodMask("Blood Mask", 2D) = "white" {}
		_BloodStrength("Blood Strength", Float) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Normal = ( ifLocalVar71 * _NormalStrength ).xyz;
			float2 temp_cast_5 = (_BloodMaskScale).xx;
			float2 uv_TexCoord102 = i.uv_texcoord * temp_cast_5 + float2( 0,0 );
			float4 lerpResult61 = lerp( _Blood1 , _Blood2 , tex2D( _BloodMask, uv_TexCoord102 ));
			float ifLocalVar68 = 0;
			if( tex2DNode66.r <= 0.0 )
				ifLocalVar68 = 0.0;
			else
				ifLocalVar68 = tex2DNode56.a;
			float4 lerpResult60 = lerp( ( tex2D( _Albedo, uv_TexCoord11 ) * _AlbedoTint ) , ( lerpResult61 * _BloodStrength ) , ifLocalVar68);
...
/*ASEBEGIN
Version=13903
1927;109;1906;964;2684.324;1911.047;2.353814;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-1559.18,-1104.622;Float;False;Property;_BloodMaskScale;Blood Mask Scale;12;0;1;0;10;0;1;FLOAT
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;102;-1230.344,-1111.302;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;83;-935.8351,-1156.176;Float;True;Property;_BloodMask;Blood Mask;13;0;Assets/Textures/VFX/clouds.png;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SimpleAddOpNode;72;327.5752,-811.8777;Float;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0,0;False;1;FLOAT4
Node;AmplifyShaderEditor.RangedFloatNode;104;-224.6893,-1058.164;Float;False;Property;_BloodStrength;Blood Strength;14;0;1;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.LerpOp;61;-273.2962,-1275.961;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0.0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;103;84.97263,-1270.421;Float;True;2;2;0;COLOR;0.0;False;1;FLOAT;0,0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.ConditionalIfNode;71;653.978,-819.3946;Float;False;False;5;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;1;FLOAT4
Node;AmplifyShaderEditor.RangedFloatNode;75;586.328,-603.6007;Float;False;Property;_NormalStrength;Normal Strength;11;0;5;0;10;0;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;74;977.3887,-768.7144;Float;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0,0,0,0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;53;737.7744,-329.156;Float;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0.0,0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1464.723,-832.6315;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;PBR Outline Blood;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;0;False;0;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;0;0;0;0;False;0;4;10;25;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;True;0.01;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=1F7008F020F667AEF119F4F01474873BEAE2B82C