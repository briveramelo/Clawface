    ...
    internal class CinemachineFramingTransposerEditor : UnityEditor.Editor
    {
        ...
        protected virtual string[] GetExcludedFields()
        {
            ...
            if (group == null)
            {
                ...
                excluded.Add(SerializedPropertyHelper.PropertyName(() => Target.m_MinimumOrthoSize));
                excluded.Add(SerializedPropertyHelper.PropertyName(() => Target.m_MaximumOrthoSize));
            }
            else 
            {
        ...
        public override void OnInspectorGUI()
        {
            if (Target.VirtualCamera.Follow == null)
                EditorGUILayout.HelpBox(
                    "Framing Transposer requires a Follow target.  Change Body to Hard Constraint if you don't want a Follow target.", 
                    MessageType.Error);
